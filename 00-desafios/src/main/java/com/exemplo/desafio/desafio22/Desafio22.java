package com.exemplo.desafio.desafio22;
...
public class Desafio22 {
    ...
    class Vertex {
        ...
        public int calculateTotalDistance(Vertex previousCity) {
            ...
            for (var edge : edgesList) {
                ...
                travelsNumber = (int) Math.ceil(edge.destinationVertex.taxQuantity / Desafio22.cargoCapacity) * 2;
    ...
    public static void main(String[] args) {
        ...
        Desafio22.cargoCapacity = Integer.parseInt(lineArgs[1]);
        ...
        Desafio22 goldBars = new Desafio22();
